...
double Visitor::operator()(const Type2& a) const { return a.get(); }
double Visitor::operator()(const Type3& a) const { return a.get(); }
#elif TYPE_COUNT == 10
double Visitor::operator()(const Type1& a) const { return a.get(); }
double Visitor::operator()(const Type2& a) const { return a.get(); }
double Visitor::operator()(const Type3& a) const { return a.get(); }
double Visitor::operator()(const Type4& a) const { return a.get(); }
double Visitor::operator()(const Type5& a) const { return a.get(); }
double Visitor::operator()(const Type6& a) const { return a.get(); }
double Visitor::operator()(const Type7& a) const { return a.get(); }
double Visitor::operator()(const Type8& a) const { return a.get(); }
double Visitor::operator()(const Type9& a) const { return a.get(); }
double Visitor::operator()(const Type10& a) const { return a.get(); }
#elif TYPE_COUNT == 20
double Visitor::operator()(const Type1& a) const { return a.get(); }
double Visitor::operator()(const Type2& a) const { return a.get(); }
double Visitor::operator()(const Type3& a) const { return a.get(); }
...
double Visitor::operator()(const Type12& a) const { return a.get(); }
double Visitor::operator()(const Type13& a) const { return a.get(); }
double Visitor::operator()(const Type14& a) const { return a.get(); }
double Visitor::operator()(const Type15& a) const { return a.get(); }
double Visitor::operator()(const Type16& a) const { return a.get(); }
double Visitor::operator()(const Type17& a) const { return a.get(); }
double Visitor::operator()(const Type18& a) const { return a.get(); }
double Visitor::operator()(const Type19& a) const { return a.get(); }
double Visitor::operator()(const Type20& a) const { return a.get(); }
#else
